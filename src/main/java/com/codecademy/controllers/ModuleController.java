...
/**
 * 
 * The ModuleController class manages the display and functionality of the
 * Module overview screen.
 * 
 * It retrieves data from the database using ModuleDAOImpl and displays it in a
 * table view.
 * 
 * Users can add, edit, and delete modules from the table.
 * 
 */
...
public class ModuleController {
    ...
    /**
     * 
     * Displays the Module overview screen where users can view, add, edit, and
     * delete modules.
     * 
     * Uses data retrieved from the database through the ModuleDAOImpl class.
     */
    public static void display() {
        ...
        TableColumn<com.codecademy.domain.Module, String> contactPersonEmail = new TableColumn<>(
